...
public struct SkinnedVertex3D : IVertexType {
    
    /// <summary>
    /// Represents the layout description for the <see cref="Vertex3D"/> structure.
    /// </summary>
    public static VertexFormat VertexLayout = new VertexFormat("SkinnedVertex3D", new VertexLayoutDescription(
    ...
    public SkinnedVertex3D(Vector3 position, Vector4 boneWeights, UInt4 boneIndices, Vector2 texCoords, Vector2 texCoords2, Vector3 normal, Vector4 tangent, Vector4 color) {
